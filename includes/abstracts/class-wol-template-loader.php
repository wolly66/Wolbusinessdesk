 ...
 *
 * Based on Gamajo_Template_Loader by Gary Jones
 *
...
class Wol_Template_Loader {
	 ...
	 * @type string
	 */
	protected $theme_template_directory = 'wolbusinessdesk-templates'; // or 'your-plugin-templates' etc.
	 ...
	 * @type string
	 */
	protected $plugin_directory = WOLBUSINESSDESK_PLUGIN_PATH; // or plugin_dir_path( dirname( __FILE__ ) ); etc.
	...
	protected function get_templates_dir() {
		return $this->plugin_directory . 'wolbusinessdesk-templates';
	}
