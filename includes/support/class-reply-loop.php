...
class Wolbusinessdesk_Support_Reply_Loop {
	...
	public function reply_loop(){
		...
		if ( $ticket_replies->have_posts() ) :
			...
			// ! TODO
			$user_can_write = wolbusinessdesk()->support_check->check_user_permissions( $filtered_single_permissions );
			//
			$ticket_is_open = wolbusinessdesk()->support_check->check_ticket_status( $this->ticket_id );
